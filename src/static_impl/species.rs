...
pub struct Species<'a> {
    ...
    pub(crate) kingdom: &'a str,
    pub(crate) phylum: &'a str,
    pub(crate) class: &'a str,
    pub(crate) order: &'a str,
    pub(crate) family: &'a str,
    pub(crate) genus: &'a str,
    pub(crate) species: &'a str,
    pub(crate) genome: &'a str,
}

impl<'a> Species<'a> {
    fn set_part(&mut self, string: &'a str) -> Result<(), Box<dyn Error>> {
    ...
    pub fn build(line: &'a str) -> Result<Self, Box<dyn Error>> {
